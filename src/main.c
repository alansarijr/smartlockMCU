...
int main(void)
{
    ...
    _delay_ms(3000);                // Wait for 1 second

    servo_init();
    servo_rotate(0);            // Rotate servo to 0 degrees (or any position you want)
    servo_rotate(90);           // Rotate servo to 90 degrees (or any position you want)
    ...
    while (1)
    {
        ...
        PORTC = 0xFF; // Initialize PORTC to 0
